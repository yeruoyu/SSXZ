    ...
    <div class="item rico-1"><a href="/ssxz/index.php/home/School/schoolDetail1/id/<?php echo ($schoolId); ?>">学校介绍</a></div>
            ...
            <div class="school-main-box">
                ...
                <div class="school-side">
                    <div class="side-bg">                        
	                    <span onclick="ShowTab(1,1,4)" id="Span1">校园新闻</span>
	                    <span onclick="ShowTab(2,1,4)" id="Span2">课堂纪实</span>
	                    <span onclick="ShowTab(3,1,4)" id="Span3">探<br /><br />营</span>
                    </div>
                </div>
                <!--左侧栏结束-->
                <!--右侧栏开始-->
                <div class="school-right">
                    <div class="school-right-box">
                        <div class="r-main-box">
                            <!--校园新闻begin-->
                            <div id="Tab1">
                                <h2 class="lv"><span>校园新闻</span></h2>
                                <div class="main-box">  
                                    <ul class="xxjs-list">
                                    	<?php if(is_array($schoolNewsList)): $i = 0; $__LIST__ = $schoolNewsList;if( count($__LIST__)==0 ) : echo "正在添加..." ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            ...
                            <!--课堂纪实begin-->
                            <div id="Tab2">
                                <h2 class="lv"><span>课堂纪实</span></h2>   
                                <div class="main-box">  
                                    <ul class="xxjs-list">
                                    	<?php if(is_array($documentaryList)): $i = 0; $__LIST__ = $documentaryList;if( count($__LIST__)==0 ) : echo "正在添加..." ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
	                                            <a href="#"><img src="/ssxz/Public/home/images/jpg1.jpg" alt="" /></a>
	                                            <div class="xxjs-list-tit"><span class="sxzd"><a href="#" ><?php echo ($vo["article_title"]); ?></a></span></div>
	                                            <div class="xxjs-main"><?php echo ($vo["acticle_excerpt"]); ?></div>
	                                            <div class="icon-ai">
                            ...
                            <!--探营begin-->
                            <div id="Tab3">
                                <h2 class="lv"><span>探营</span></h2>
                                <div class="main-box">  
                                    <ul class="xxjs-list">
                                    	<?php if(is_array($campList)): $i = 0; $__LIST__ = $campList;if( count($__LIST__)==0 ) : echo "正在添加..." ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
	                                            <a href="#"><img src="/ssxz/Public/home/images/jpg1.jpg" alt="" /></a>
	                                            <div class="xxjs-list-tit"><span class="sxzd"><a href="#" ><?php echo ($vo["article_title"]); ?></a></span></div>
	                                            <div class="xxjs-main"><?php echo ($vo["acticle_excerpt"]); ?></div>
	                                            <div class="icon-ai">
                        ...
                        <SCRIPT type="text/javascript">ShowTab(1, 1, 4);</SCRIPT>
                    </div>
                </div>
                <!--右侧栏结束-->        
            </div>
