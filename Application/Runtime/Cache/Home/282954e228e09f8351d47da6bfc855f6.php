    ...
    <div class="item rico-1"><a href="/ssxz/index.php/home/School/schoolDetail1/id/<?php echo ($schoolId); ?>">学校介绍</a></div>
            ...
            <div class="school-main-box">
                ...
                <div class="school-side">
                    <div class="side-bg">                        
	                    <span onclick="ShowTab(1,1,3)" id="Span1">学校视频</span>
	                    <span onclick="ShowTab(2,1,3)" id="Span2">拍客</span>
                    </div>
                </div>
                <!--左侧栏结束-->
                <!--右侧栏开始-->
                <div class="school-right">
                    <div class="school-right-box">
                        <div class="r-main-box">
                            <!--学生故事begin-->
                            <div id="Tab1">
                                <h2 class="lv"><span>学校视频</span></h2>
                                <div class="main-box">  
                                    <ul class="sp-list">
                                    	<?php if(is_array($videoList)): $i = 0; $__LIST__ = $videoList;if( count($__LIST__)==0 ) : echo "正在添加中..." ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="cur">
	                                            <a href="#">
	                                                <div class="img"><img src="/ssxz/Public/home/images/s_03.jpg" /></div>
	                                                <div class="title"><?php echo ($vo["images_title"]); ?></div>
	                                                <div class="rep">
	                                                    <span class="r1">阅读数<?php echo ($vo["images_read"]); ?></span>
	                                                    <span class="r2">跟帖数<?php echo ($vo["images_comment"]); ?></span>
	                                                    <span class="r3"><?php echo ($vo["images_createtime"]); ?></span>
	                                                </div>
	                                            </a>
	                                        </li><?php endforeach; endif; else: echo "正在添加中..." ;endif; ?>
        ...
        <!--中间end-->
        <!--评论begin-->
        <div class="container comment"  style=" position:relative; border-bottom: 2px solid #0fa484;">
