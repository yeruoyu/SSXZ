...
<div class="item col1">
    <div class="title">
        <a href="/ssxz/index.php/home/topic/topicList" class="right">更多...</a>
        <span>最有用的话题</span>
    </div>
    <ul id="usefulTopic" class="zy-w"><!-- you-w -->
...
<div class="footer">
    ...
    <script type="text/javascript">
    	...
    	function showUserfulTopic(cataloge,dispId){
    		var usefulArticleQueryUrl = "/ssxz/index.php/home/index/usefulTopicQuery";
    		$.ajax({
				type: 'POST',
				...
				success: function(msg){
					if(msg.data!=null){
						...
						msg.data.forEach(function(vo){
							var articleItem='<li>'
								+'<i>'+rowIndex+'</i>'
								+'<a href="/ssxz/index.php/home/topic/topicDetail/id/'+vo.article_id+'"><div>'+vo.article_title+'</div></a>'
								+'</li>';	
