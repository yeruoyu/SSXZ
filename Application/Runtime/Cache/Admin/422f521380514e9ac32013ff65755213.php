...
<nav class="navbar user-info-navbar" role="navigation">
	...
	jQuery(document).ready(function($)
	{
		...
		oTable.dataTable({
			...
			sInfoEmpty: "没有数据",
			sAjaxSource: "/ssxz/admin.php/Teacher/teacherListQuery",
			...
			aoColumns: [
						{"mData" : "teacher_id","asSorting": [ "desc", "asc", "desc" ] },
						{"mData" : "teacher_name"},
						{"mData" : "teacher_type"},
						{"mData" : "school_name"},
						{"mData" : "teacher_status"},
						{"mData" : "teacher_id"}
					],
			columnDefs: [
			               {
