					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div style="float:right">
								<a href="/ssxz/admin.php/Project/projectDetail"  class="btn btn-success">添加招生信息</a>
							</div>
						</div>
	...
	<script type="text/javascript">
		jQuery(document).ready(function($)
		{
			var oTable = $("#tb_project").dataTable({
				...
				sInfoEmpty: "没有数据",
				sAjaxSource: "/ssxz/admin.php/Project/projectListQuery",
				...
				columnDefs: [
				              {"render": function ( data, type, row ) {
				                   ...
				                   "render": function ( data, type, row) {
										return '<a href="/ssxz/admin.php/Project/projectDetail/id/'+data+'/edit/true/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">编辑</a>';
				                   },
				                   "targets": 4
				               },
