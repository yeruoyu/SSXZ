					...
					<div class="panel panel-default">
						...
						<tbody class="middle-align">
							<?php if(is_array($newslist)): $i = 0; $__LIST__ = $newslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<td>
									<input type="checkbox" class="cbr" value="<?php echo ($vo["news_id"]); ?>">
								</td>
								<td><?php echo ($vo["news_title"]); ?></td>
								<td><?php echo ($vo["news_type"]); ?></td>
								<td><?php echo ($vo["news_status"]); ?></td>
								<td>
									<a href="/ssxz/admin.php/News/articleDetail/id/<?php echo ($vo["article_id"]); ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
										编辑
									</a>
