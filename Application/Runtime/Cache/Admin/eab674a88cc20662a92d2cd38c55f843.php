				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<!-- Content -->
							<form role="form" id="formArticle"  action="/ssxz/admin.php/Article/articleSave" method="post" method="post" class="form-horizontal validate">
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="text" class="form-control" name="article_title" value="<?php echo ($articleInfo["article_title"]); ?>" data-validate="required" data-message-required="文章标题不能为空。" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="article_keyword">文章关键字</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="article_keyword" value="<?php echo ($articleInfo["article_keyword"]); ?>" data-validate="required" data-message-required="文章检索关键字不能为空。" />
									</div>
								</div>
								<div class="form-group">
