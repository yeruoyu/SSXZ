					...
					<div class="panel panel-default">
						...
						<tbody class="middle-align">
							<?php if(is_array($schoolList)): $i = 0; $__LIST__ = $schoolList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<td>
									<input type="checkbox" class="cbr" value="<?php echo ($vo["school_id"]); ?>">
								</td>
								<td><?php echo ($vo["school_name"]); ?></td>
								<td><?php echo ($vo["school_attention"]); ?></td>
								<td><?php echo ($vo["school_comments"]); ?></td>
								<td>
									<?php if(($vo["school_isnew"]) == "1"): ?>是<?php endif; ?>
									<?php if(($vo["school_isnew"]) == "0"): ?>否<?php endif; ?>
								</td>
								<td>
									<?php if(($vo["school_status"]) == "1"): ?>正常<?php endif; ?>
									<?php if(($vo["school_attention"]) == "0"): ?>停用<?php endif; ?>
									<?php if(($vo["school_status"]) == "9"): ?>注销<?php endif; ?>
								</td>
								<td>
