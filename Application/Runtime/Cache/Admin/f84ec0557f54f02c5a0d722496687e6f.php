			...
			<div class="page-title">
				<div class="breadcrumb-env">
					<ol class="breadcrumb bc-1">
						...
						<li>学习小组管理</li>
						<li class="active"><strong>学习小组列表</strong></li>
					</ol>		
				</div>
			</div>
			<!-- Content Panel -->
	...
	<script type="text/javascript">
		jQuery(document).ready(function($)
		{
			...
			oTable.dataTable({
				...
				sInfoEmpty: "没有数据",
				sAjaxSource: "/ssxz/admin.php/StudyGroup/studyGroupListQuery",
				               ...
				               },
				               {
				                  "render": function ( data, type, row ) {
										if(row['school_status']==1){
											return '<a href="/ssxz/admin.php/StudyGroup/studyGroupDetail/id/'+data+'/edit/true/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">编辑</a> <a href="/ssxz/admin.php/studyGroup/disableStudyGroup/id/'+data+'/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">无效</a>';
										}else{
											return '<a href="/ssxz/admin.php/StudyGroup/studyGroupDetail/id/'+data+'/edit/true/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">编辑</a> <a href="/ssxz/admin.php/studyGroup/enableStudyGroup/id/'+data+'/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">有效</a>';
										}
