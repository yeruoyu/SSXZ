	...
	<script type="text/javascript">
		jQuery(document).ready(function($)
		{
			var oTable = $("#tb_comment").dataTable({
				...
				sInfoEmpty: "没有数据",
				sAjaxSource: "/ssxz/admin.php/Comment/commentListQuery",
				...
				columnDefs: [
				               ...
				               {
				                   "render": function ( data, type, row) {
				                	   return '<a href="/ssxz/admin.php/Comment/commentDetail/id/'+data+'/edit/true/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">编辑</a>';
										//if(row['article_status']==1){
										//	return '<a href="/ssxz/admin.php/Comment/commentDetail/id/'+data+'/edit/true/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">通过</a> <a href="/ssxz/admin.php/Article/disableArticle/id/'+data+'/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">无效</a>';
										//}else{
										//	return '<a href="/ssxz/admin.php/Comment/commentDetail/id/'+data+'/edit/true/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">编辑</a> <a href="/ssxz/admin.php/Article/enableArticle/id/'+data+'/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">有效</a>';
										//}
				                   },
				                   "targets": 9
				               },
