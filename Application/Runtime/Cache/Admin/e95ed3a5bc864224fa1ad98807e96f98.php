					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div style="float:right">
								<a href="/ssxz/admin.php/Activity/activityDetail"  class="btn btn-success">添加活动</a>
							</div>
						</div>
	...
	<script type="text/javascript">
		jQuery(document).ready(function($)
		{
			var oTable = $("#tb_activity").dataTable({
				...
				sInfoEmpty: "没有数据",
				sAjaxSource: "/ssxz/admin.php/Activity/activityListQuery",
				               ...
				               },
				               {
				                   "render": function ( data, type, row) {
										...
										if(row['activity_status']==1){
											return '<a href="/ssxz/admin.php/Activity/activityDetail/id/'+data+'/edit/true/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">编辑</a>';
										}else{
											return '<a href="/ssxz/admin.php/Activity/activityDetail/id/'+data+'/edit/true/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">编辑</a>';
										}
				                   },
