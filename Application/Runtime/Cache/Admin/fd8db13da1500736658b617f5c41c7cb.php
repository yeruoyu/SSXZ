					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div style="float:right">
								<a href="/ssxz/admin.php/User/userDetail"  class="btn btn-success">添加用户</a>
							</div>
						</div>
	...
	<script type="text/javascript">
		jQuery(document).ready(function($)
		{
			var oTable = $("#tb_article").dataTable({
				...
				sInfoEmpty: "没有数据",
				sAjaxSource: "/ssxz/admin.php/User/userListQuery",
				...
				aoColumns: [
					{"mData" : "user_id","asSorting": [ "desc", "asc", "desc" ] },
					{"mData" : "user_type"},
					{"mData" : "user_name"},
					{"mData" : "user_school_id"},
					{"mData" : "user_status"},
					{"mData" : "user_id"}
				],
				columnDefs: [
				               ...
				               },
				               {
				                   "render": function ( data, type, row) {
										...
										if(row['article_status']==1){
											return '<a href="/ssxz/admin.php/User/userDetail/id/'+data+'/edit/true/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">编辑</a> <a href="/ssxz/admin.php/Topic/disableTopic/id/'+data+'/start/'+oTable.fnSettings()._iDisplayStart+'/pagesize/'+oTable.fnSettings()._iDisplayLength+'" class="btn btn-secondary btn-sm btn-icon icon-left">无效</a>';
										}else{
