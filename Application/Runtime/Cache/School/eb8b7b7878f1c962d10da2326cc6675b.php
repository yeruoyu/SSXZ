				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 校园新闻列表</h3>
							<div style="float:right">
								<a href="/ssxz/school.php/News/newsDetail" class="btn btn-success">添加校园新闻</a>
							</div>
						</div>
							...
							<table class="table table-bordered table-striped" id="example-2">
								<thead>
									<tr>
										...
										<th style="width:60%">新闻标题</th>
										<th style="width:20%">新闻状态</th>
										<th>操作</th>
									</tr>
								</thead>
								<tbody class="middle-align">
									<?php if(is_array($newslist)): $i = 0; $__LIST__ = $newslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<a href="/ssxz/school.php/News/newsDetail/id/<?php echo ($vo["article_id"]); ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
												编辑
											</a>
										</td>
