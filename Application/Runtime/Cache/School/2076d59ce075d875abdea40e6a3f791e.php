				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 招生信息</h3>
						</div>
						<div class="panel-body">
							<form role="form" id="form" action="/ssxz/school.php/Enroll/saveEnroll" method="post" class="form-horizontal validate">
								<div class="form-group">
									<label class="col-sm-2 control-label">招生分类</label>
									<div class="col-sm-4">
										<select class="form-control" name="enrollment_type" value="<?php echo ($enrollInfo["enrollment_type"]); ?>">
											<option value="0">-请选择-</option>
											<option value="1">小学</option>
											<option value="2">初中</option>
											<option value="3">初中</option>
											<option value="4">高中</option>
											<option value="5">预科</option>
										</select>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">招生标题</label>
									<div class="col-sm-8">
										<input type="hidden" class="form-control" name="action" value="<?php echo ($action); ?>"/>
										<input type="hidden" class="form-control" name="enrollment_id" value="<?php echo ($enrollInfo["enrollment_id"]); ?>"/>
										<input type="hidden" class="form-control" name="article_id" value="<?php echo ($enrollInfo["exrollment_article_id"]); ?>"/>
										<input type="text" class="form-control" name="enrollment_title" value="<?php echo ($enrollInfo["enrollment_title"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">招生关键字</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="article_keyword" value="<?php echo ($articleInfo["article_keyword"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">招生说明</label>
									<div class="col-sm-8">
										<script id="article_detail" name="article_detail" type="text/plain" style="width:100%;height:500px;" >
											<?php echo (htmlspecialchars_decode($articleInfo["article_detail"])); ?></script>
									</div>
								</div>
								<div class="form-group">
