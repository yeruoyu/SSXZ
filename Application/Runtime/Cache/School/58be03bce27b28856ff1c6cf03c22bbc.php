				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form role="form" id="form1" action="/ssxz/school.php/School/saveAchievement" method="post" class="form-horizontal validate">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										<a href="/ssxz/school.php/School/achievementList" class="btn btn-info">返回</a>
									</div>
								</div>
							</form>
						</div>
