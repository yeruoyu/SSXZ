							...
							<form role="form" id="form3" method="post" class="validate">
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<a href="/ssxz/school.php/School/teacherDetail" class="btn btn-success">添加</a>
									</div>
								</div>
							</form>
							...
							<table class="table table-bordered table-striped" id="example-2">
								...
								<tbody class="middle-align">
									<?php if(is_array($teacherList)): $i = 0; $__LIST__ = $teacherList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										<td>
											<input type="checkbox" class="cbr" value="<?php echo ($vo["teacher_id"]); ?>">
										</td>
										<td><?php echo ($vo["teacher_name"]); ?></td>
										<td><?php echo ($vo["teacher_tag"]); ?></td>
										<td><?php echo ($vo["teacher_school"]); ?></td>
										<td>
											<?php if(($vo["teacher_status"] == 1)): ?>有效
											<?php else: ?>
												无效<?php endif; ?>
										</td>
										<td>
											<a href="/ssxz/school.php/School/teacherDetail/id/<?php echo ($vo["teacher_id"]); ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
												编辑
											</a>
										</td>
