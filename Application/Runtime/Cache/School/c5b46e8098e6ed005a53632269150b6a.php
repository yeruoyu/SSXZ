				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 师资团队</h3>
						</div>
						<div class="panel-body">
							<form role="form" id="form1" action="/ssxz/school.php/School/saveTeacher" enctype="multipart/form-data" method="post" class="form-horizontal validate">
								
								<div class="form-group">
									<label class="col-sm-2 control-label">教师姓名</label>
									<div class="col-sm-2">
										<input type="hidden" class="form-control" name="action" value="<?php echo ($action); ?>"/>
										<input type="hidden" class="form-control" name="teacher_id" value="<?php echo ($teacherInfo["teacher_id"]); ?>"/>
										<input type="hidden" class="form-control" name="teacher_school_id" value="<?php echo ($schoolInfo["school_id"]); ?>"/>
										<input type="text" class="form-control" name="teacher_name" value="<?php echo ($teacherInfo["teacher_name"]); ?>"/>
									</div>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">教师标签</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="teacher_tag" value="<?php echo ($teacherInfo["teacher_tag"]); ?>"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<img alt="" src="/ssxz/Uploads/<?php echo ($teacherInfo["teacher_photo"]); ?>"/>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">教师介绍</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<select class="form-control" name="teacher_status">
											<?php if(($teacherInfo["teacher_status"] == 1)): ?><option value="1" selected>有效</option>
												<option value="0">无效</option>
											<?php else: ?>
												<option value="1" >有效</option>
												<option value="0" selected>无效</option><?php endif; ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<a href="/ssxz/school.php/School/teacherList" class="btn btn-info">返回</a>
									</div>
								</div>
