...
<!-- 				<div class="title-env">
				...
				<div class="breadcrumb-env">
					<ol class="breadcrumb bc-1">
						...
						<li>
							<a href="customer/customerList.html">学生会</a>
						</li>
						<li class="active">
							<strong>学生故事</strong>
						</li>
				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 学生故事</h3>
						</div>
						<div class="panel-body">
							<form role="form" id="form1" action="/ssxz/school.php/Student/saveStory" method="post" class="form-horizontal validate">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<select class="form-control" name="article_status">
											<?php if(($articleInfo["article_status"] == 1)): ?><option value="1" selected>有效</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										<a href="/ssxz/school.php/Student/storyList" class="btn btn-info">返回</a>
									</div>
								</div>
							</form>
						</div>
