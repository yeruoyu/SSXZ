				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 印象校园</h3>
						</div>
						<div class="panel-body">
							<form role="form" id="form1" method="post" action="/ssxz/school.php/School/saveImage" class="form-horizontal validate">
								<div class="form-group">
									<label class="col-sm-2 control-label">照片标题</label>
									<div class="col-sm-8">
										<input type="hidden" class="form-control" name="images_id" value ="<?php echo ($imageInfo["images_id"]); ?>"/>

										<input type="text" class="form-control" name="images_title" value ="<?php echo ($imageInfo["images_title"]); ?>"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="file" class="form-control" name="images_path"/>
									</div>
									<label class="col-sm-2 control-label">状态</label>
									<div class="col-sm-2">
										<select class="form-control" name="images_status">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<img src="/ssxz/Uploads/<?php echo ($imageInfo["images_path"]); ?>"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<a href="/ssxz/school.php/School/imageList" class="btn btn-info">返回</a>
									</div>
								</div>
