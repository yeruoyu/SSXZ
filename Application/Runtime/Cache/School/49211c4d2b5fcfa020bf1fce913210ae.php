				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 课堂特色</h3>
						</div>
						<div class="panel-body">
							<form role="form" id="form1" action="/ssxz/school.php/School/saveFeature" method="post" class="form-horizontal validate">
								<div class="form-group">
									<label class="col-sm-2 control-label">课堂特色</label>
									<div class="col-sm-10">
										<input type="hidden" class="form-control" id="article_id" name="article_id" value="<?php echo ($feature["article_id"]); ?>"/>
										<script id="article_detail" name="article_detail" type="text/plain" style="width:100%;height:500px;" >
										<?php echo (htmlspecialchars_decode($feature["article_detail"])); ?></script>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<a href="/ssxz/school.php/School/feature" class="btn btn-white">取消</a>
									</div>
								</div>
							</form>
						</div>
