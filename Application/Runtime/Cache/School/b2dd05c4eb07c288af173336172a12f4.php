				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 拍客列表</h3>
						</div>
							...
							<form role="form" id="form3" method="post" class="validate">
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<a href="/ssxz/school.php/Video/shootDetail" class="btn btn-success">添加</a>
									</div>
								</div>
							</form>
							...
							<table class="table table-bordered table-striped" id="example-2">
								...
								<tbody class="middle-align">
									<?php if(is_array($menulist)): $i = 0; $__LIST__ = $menulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<a href="/ssxz/school.php/Video/shootDetail/id/{#}" class="btn btn-secondary btn-sm btn-icon icon-left">
												编辑
											</a>
										</td>
