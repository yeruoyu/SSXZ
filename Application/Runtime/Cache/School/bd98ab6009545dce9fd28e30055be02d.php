				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 探营列表</h3>
							<div style="float:right">
								<a href="/ssxz/school.php/News/campDetail" class="btn btn-success">添加探营</a>
							</div>
						</div>
						<div class="panel-body">
							...
							<table class="table table-bordered table-striped" id="example-2">
								...
								<tbody class="middle-align">
									<?php if(is_array($campList)): $i = 0; $__LIST__ = $campList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										<td>
										...
										<td>
											<a href="/ssxz/school.php/News/campDetail/id/<?php echo ($vo["article_id"]); ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
												编辑
											</a>
										</td>
