				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 招生简章</h3>
						</div>
						<div class="panel-body">
							<form role="form" id="form1" action="/ssxz/school.php/Enroll/saveGuide" method="post" class="form-horizontal validate">
								
								<div class="form-group">
									<label class="col-sm-2 control-label">简章标题</label>
									<div class="col-sm-8">
