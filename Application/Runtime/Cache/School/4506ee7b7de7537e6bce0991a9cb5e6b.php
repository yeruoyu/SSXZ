					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<div style="float:left">
								<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 招生信息列表</h3>
							</div>
							<div style="float:right">
								<a href="/ssxz/school.php/Enroll/enrollDetail" class="btn btn-success">添加招生信息</a>
							</div>
						</div>
							...
							<table class="table table-bordered table-striped" id="example-2">
								...
								<tbody class="middle-align">
									<?php if(is_array($enrollList)): $i = 0; $__LIST__ = $enrollList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td><?php echo ($vo["enrollment_type"]); ?></td>
										<td><?php echo ($vo["enrollment_title"]); ?></td>
										<td><?php echo ($vo["enrollment_status"]); ?></td>
										<td>
											<a href="/ssxz/school.php/Enroll/enrollDetail/id/<?php echo ($vo["enrollment_id"]); ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
												编辑
											</a>
										</td>
