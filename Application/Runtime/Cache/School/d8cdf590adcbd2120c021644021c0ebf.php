					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div style="float:right">
								<a href="/ssxz/school.php/School/imageDetail" class="btn btn-success">添加印象校园</a>
							</div>
						</div>
						<div class="panel-body">
							...
							<table class="table table-bordered table-striped" id="example-2">
								...
								<tbody class="middle-align">
									<?php if(is_array($imageslist)): $i = 0; $__LIST__ = $imageslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										<td>
											<input type="checkbox" class="cbr" value="<?php echo ($vo["images_id"]); ?>">
										</td>
										<td><?php echo ($vo["images_title"]); ?></td>
										<td><?php echo ($vo["image_filename"]); ?></td>
										<td><?php echo ($vo["image_status"]); ?></td>
										<td>
											<a href="/ssxz/school.php/School/imageDetail/id/<?php echo ($vo["images_id"]); ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
												编辑
											</a>
										</td>
