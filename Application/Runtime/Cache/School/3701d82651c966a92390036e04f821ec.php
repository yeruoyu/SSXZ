				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 招生简章列表</h3>
							<div style="float:right">
								<a href="/ssxz/school.php/Enroll/guideDetail" class="btn btn-success">添加招生简章</a>
							</div>
						</div>
							...
							<table class="table table-bordered table-striped" id="example-2">
								<thead>
									<tr>
										...
										<th style="width:60%">简章标题</th>
										<th style="width:20%">简章状态</th>
										<th style="text-align:center">操作</th>
									</tr>
								</thead>
								<tbody class="middle-align">
									<?php if(is_array($enrollList)): $i = 0; $__LIST__ = $enrollList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										<td>
											<input type="checkbox" class="cbr" value="<?php echo ($vo["enrollment_id"]); ?>">
										</td>
										<td><?php echo ($vo["enrollment_title"]); ?></td>
										<td><?php echo ($vo["enrollment_status"]); ?></td>
										<td style="text-align:center">
											<a href="/ssxz/school.php/Enroll/guideDetail/id/<?php echo ($vo["enrollment_id"]); ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
												编辑
											</a>
										</td>
