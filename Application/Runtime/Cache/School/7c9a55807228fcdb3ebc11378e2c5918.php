...
<!-- 				<div class="title-env">
				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><?php echo ($schoolInfo["school_name"]); ?> - 招生活动</h3>
						</div>
						<div class="panel-body">
							<form role="form" id="form1" method="post" class="form-horizontal validate">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">活动关键字</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="date-and-time">
											...
											<input type="text" class="form-control timepicker" data-template="dropdown" data-show-seconds="true" data-default-time="00:00 AM" data-show-meridian="false" data-minute-step="5" data-second-step="5" />
	...
	<script type="text/javascript" src="/ssxz/Public/assets/js/timepicker/bootstrap-timepicker.min.js"></script>
